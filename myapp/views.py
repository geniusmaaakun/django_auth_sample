...
class UserCreate(generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        return redirect('video:user_create_done')
...
class UserUpdate(OnlyYouMixin, generic.UpdateView):
    ...
    def get_success_url(self):
        return resolve_url('video:user_detail', pk=self.kwargs['pk'])
...
class PasswordReset(PasswordResetView):
    ...
    success_url = reverse_lazy('video:password_reset_done')
...
class PasswordResetConfirm(PasswordResetConfirmView):
    ...
    success_url = reverse_lazy('video:password_reset_complete')
...
class EmailChange(LoginRequiredMixin, generic.FormView):
    ...
    def form_valid(self, form):
        ...
        return redirect('video:email_change_done')
